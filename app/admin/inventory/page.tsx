        ...
        <div>
            ...
            <div className="flex flex-row items-start px-20 bg-white mb-10">
                <div className="lg:shadow-custom font-inter flex flex-col w-full m-4 lg:m-10 p-10 rounded-2xl">
                    ...
                    <div className="flex flex-row mb-8">
                        <button className="font-semibold text-grey w-1/4 text-left text-green underline"> All Orders </button>
                        ...
                        <button className="font-semibold text-grey w-1/4 text-left"> Claimed</button>
                    </div>
                    ...
                    <div className="w-full bg-[#F4F4F4] rounded-md shadow-sm p-7 px-10 mb-3 flex items-center">
                        <div className="w-full grid grid-cols-[1fr_2fr_3fr_3fr_2fr] flex items-center">
                            <button className="font-semibold text-left">Order ID</button>
                            <button className="font-semibold text-left">Name</button>
                            <button className="font-semibold text-left">Product</button>
                            <button className="font-semibold text-left">Note</button>
            ...
            <div className="flex flex-row items-start px-20 bg-white mb-10">
                <div className="lg:shadow-custom font-inter flex flex-col w-full m-4 lg:m-10 p-10 rounded-2xl">
                    ...
                    <div className="flex flex-row mb-8">
                        <button className="font-semibold text-grey w-1/4 text-left text-green underline"> All Requested Item </button>
                    ...
                    <div className="w-full bg-[#F4F4F4] rounded-md shadow-sm p-7 px-10 mb-3 flex items-center">
                        <div className="w-full flex items-center">
                            <button className="font-semibold w-1/6 text-left">Date</button>
                            <button className="font-semibold w-1/6 text-left">Name</button>
                            <button className="font-semibold w-1/4 text-left">Product</button>
                            <button className="font-semibold w-1/3 text-left">Note</button>
