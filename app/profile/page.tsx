    ...
    return(
        <div>
            <div className="flex flex-row w-full h-screen">
                <div className="w-full lg:h-screen bg-cover bg-no-repeat bg-center flex flex-col justify-center items-start pl-20">
                    ...
                    <p className="font-inter font-bold tracking-tight ">
                        Student
                    </p>
                    <p className="font-inter tracking-tight text-grey font-inter italic text-sm">
                        If you notice any discrepancies with your data, please contact the admin.
                    </p>
                </div>
                ...
                <div className="flex gap-4 justify-center items-center px-10">
                    ...
                    <div className="w-40 h-40 bg-gradient-to-b from-orange-400 to-orange-300 rounded-xl flex flex-col justify-center items-center shadow-lg">
                        <p className="font-inter text-4xl font-bold text-white">15</p>
                        <p className="font-inter text-md text-white mt-2">Pending Orders</p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-row">
                <div className="lg:shadow-custom font-inter flex flex-col w-full m-4 lg:m-10 p-10 rounded-2xl">
                    <h2 className="font-bold text-4xl mb-10">Your Ongoing Tasks</h2>
                    ...
                    <hr className="border-2 border-gray-150" />
                        <div className="flex justify-between items-center text-gray-700 font-bold p-2">
                            ...
                            <p className="font-inter font-bold p-2">Water Plants in Garden</p>
                            <p className="p-2">
                ...
                <div className="lg:shadow-custom font-inter flex flex-col w-full m-4 lg:m-10 p-10 rounded-2xl">
                    <h2 className="font-bold text-4xl mb-10">Your Pending Tasks</h2>
                ...
                <div className="lg:shadow-custom font-inter flex flex-col w-full m-4 lg:m-10 p-10 rounded-2xl">
                    ...
                    <div className="flex gap-4 justify-center items-center px-10">
                        <div className="w-40 h-40 bg-gradient-to-b from-red-400 to-red-300 rounded-xl flex flex-col justify-center items-center shadow-lg">
                            <p className="font-inter text-4xl font-bold text-white">15</p>
                            <p className="font-inter text-md font-medium text-white mt-2">Rejected Orders</p>
                        </div>
                        <div className="w-40 h-40 bg-gradient-to-b from-orange-400 to-orange-300 rounded-xl flex flex-col justify-center items-center shadow-lg">
                            <p className="font-inter text-4xl font-bold text-white">15</p>
                            <p className="font-inter text-md text-white mt-2">Pending Orders</p>
                        ...
                        <div className="w-40 h-40 bg-gradient-to-b from-green-400 to-green-300 rounded-xl flex flex-col justify-center items-center shadow-lg">
                            <p className="font-inter text-4xl font-bold text-white">15</p>
                            <p className="font-inter text-md text-white mt-2">Claimed Orders</p>
                        </div>
                    </div>
                    <div className="py-10">
                        <hr className="border-2 border-gray-150" />
                        ...
                        <div className="flex justify-between items-center text-gray-700 font-bold p-2">
                            <p className="font-inter font-bold p-2 ">1</p>
                            <p className="font-inter font-bold p-2">ABCDEFGHI12345</p>
                            <p className="font-inter font-bold p-2">NIKE Shoes Panjangin Dikit Biar Figma-nya Bagussss</p>
                            <p className="font-inter font-bold p-2">30 Credits</p>
                            <p className="p-2">
                                    <span className="font-inter font-bold bg-orange-300 text-white px-2 py-1 rounded-md text-sm">
            ...
            <div className="flex flex-row h-screen bg-white">
                <div className="lg:shadow-custom font-inter flex flex-col w-full m-4 lg:m-10 p-10 rounded-2xl">
                    ...
                    <div className="flex gap-4 justify-center items-center px-10">
                        <div className="w-40 h-40 bg-gradient-to-b from-red-400 to-red-300 rounded-xl flex flex-col justify-center items-center shadow-lg">
                            <p className="font-inter text-4xl font-bold text-white">15</p>
                            <p className="font-inter text-md font-medium text-white mt-2">Rejected Quest</p>
                        </div>
                        <div className="w-40 h-40 bg-gradient-to-b from-orange-400 to-orange-300 rounded-xl flex flex-col justify-center items-center shadow-lg">
                            <p className="font-inter text-4xl font-bold text-white">15</p>
                            <p className="font-inter text-md text-white mt-2">Pending Quest</p>
                        </div>
                        <div className="w-40 h-40 bg-gradient-to-b from-green-400 to-green-300 rounded-xl flex flex-col justify-center items-center shadow-lg">
                            <p className="font-inter text-4xl font-bold text-white">15</p>
                            <p className="font-inter text-md text-white mt-2">Claimed Quest</p>
                        </div>
                    </div>
                    <div className="py-10">
                        <hr className="border-2 border-gray-150" />
